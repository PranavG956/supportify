...
const page = () => {
    ...
    useEffect(() => {
      document.title = "Login - Supportify";
    if(session){
  ...
  return (
    <div className="flex gap-4 flex-col justify-center items-center px-[10vw] min-h-[calc(100vh-155px)] sm:min-h-[calc(100vh-116px)] text-white">
      ...
      <div className="social_buttons flex flex-col gap-3">
        ...
        <button onClick={()=>signIn("github")} type="button" className="cursor-pointer text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2">

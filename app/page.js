...
export default function Home() {
  return (
    <div className="flex gap-4 flex-col justify-center items-center px-[10vw] min-h-[calc(100vh-155px)] sm:min-h-[calc(100vh-116px)] text-white">
      <div className="flex gap-2 relative">
      <div className="font-bold sm:text-4xl text-2xl">
        Supportify
      </div>
        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" className="injected-svg invert" data-src="https://cdn.hugeicons.com/icons/save-money-dollar-solid-sharp.svg?v=2.0" role="img" color="#000000">
      ...
      <p className="text-center">A platform for crowdfunding for creators.Get funded by your fans and followers.</p>
      <div>
        <Link href="/login">
      <button type="button" className="cursor-pointer text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm sm:px-5 px-3 py-2.5 text-center m-2">Start Now!!</button></Link>
      <Link href="/about">
      <button type="button" className="cursor-pointer text-white bg-gradient-to-r from-gray-400 via-gray-800 to-gray-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-gray-800 dark:focus:ring-gray-800 shadow-lg shadow-gray-500/50 dark:shadow-lg dark:shadow-gray-800/80 font-medium rounded-lg text-sm sm:px-5 px-3 py-2.5 text-center m-2">Read-More</button></Link>
      </div>
      <div className="h-[1px] w-full bg-gray-500 "></div>
      <div className="text-xl font-bold">Get Funded Now</div>
      <div className="flex justify-around w-full items-center">
        <img className="hidden sm:block rounded-full w-[100px] h-[100px]" src="https://i.pinimg.com/736x/03/cc/85/03cc8547a34747782f418e6dc0667a00.jpg" alt="" />
        <img className="rounded-full w-[100px] h-[100px]" src="https://i.pinimg.com/736x/8c/33/e3/8c33e3983e190056f12c75841a8ecdd0.jpg" alt="" />
        <img className="rounded-full w-[100px] h-[100px]" src="https://i.pinimg.com/736x/4d/95/34/4d9534f69d2c8744a991be6ed128fea5.jpg" alt="" />
      </div>
    </div>
  );
}
